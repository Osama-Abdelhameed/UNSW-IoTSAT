...
class test(gr.top_block):
    ...
    def __init__(self, CCSDS_sync_word="00011010110011111111110000011101", Packet_Length=241):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/sat1/satellite_1/satellite1/new_data/tx_input.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/sat1/satellite_1/satellite1/sat2.txt', False)
